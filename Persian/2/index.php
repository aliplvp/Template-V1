...
defined('Title') || define('Title', 'چگونگی تایید اصالت عکس قبرستان بقیع');
defined('SubTitle') || define('SubTitle', 'مسئله اصلی من این بود که این عکس چگونه واقعاً اصالتش تأیید شود ؟ ');
